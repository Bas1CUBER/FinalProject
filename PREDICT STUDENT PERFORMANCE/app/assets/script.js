...
function generateInsights(inputData, result) {
    ...
    // Support systems (default values ensure this is always true)
    factors.push({
        icon: "🤝",
        title: "Support Systems Available",
        description: "Educational support from school or family is beneficial"
    });

    // Limit to exactly 3 factors for simplicity
    const limitedFactors = factors.slice(0, 3);

    // Generate single recommendation (user requested simplicity)
